...
public class ShooterControllerPIDVSA {
    ...
    public double HIGH_VELOCITY = 1700;
    public double MID_VELOCITY = 1400;
    public double LOW_VELOCITY = 1100;


    public static double kS = 0.59;    // Volts
    public static double kV = 0.00455;  // Volts per RPM
    public static double kA = 0.001;   // Volts per RPM/s
    ...
    public void initialize(HardwareMap hardwareMap) {
        shooterMotorLeft = hardwareMap.get(DcMotorEx.class, "shooter_l");
        shooterMotorRight = hardwareMap.get(DcMotorEx.class, "shooter_r");
    ...
    public void showTelemetry(Telemetry telemetry) {
        ...
        telemetry.addData("Ready to Shoot (tolerance 50)", isReadyToShoot(50) ? "YES" : "NO");
    }
}
